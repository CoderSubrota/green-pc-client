                ...
                <div className="lg:flex justify-start lg:gap-28">
                    <div className>
                       ...
                       <div className="mt-8 md:flex justify-start md:gap-4">
                            <input id="inputColor" type="email" placeholder="Your Email" name="email" className="text-blue-400 w-full md:w-1/2 p-4 grid place-items-center border rounded-md focus:outline-none" required/>
