...
const Slider = () => {
  ...
  <div id="slide1" className="carousel-item h-screen relative w-full">
    ...
    <img src="https://i.ibb.co/Y7PtfTm/banner1.jpg" alt='images' 
    className="w-full " />
   ...
   text-white  transform -translate-y-1/2 left-5 right-5 top-1/2'>
    ...
    <button  onClick={()=>goDashboard()}  className="btn btn-primary text-white my-4">Get started 
  ...
  <div id="slide2" className="carousel-item h-screen  relative w-full">
    ...
    <img src="https://i.ibb.co/2hRrzbZ/banner2.webp" alt='images' 
    className="w-full " />
...
<div className='absolute w-auto -mt-8 opacity-90   text-center font-bold 
  ...
  <div id="slide3" className="carousel-item h-screen  relative w-full">
    ...
    <img src="https://i.ibb.co/B41mkBD/banner4.jpg" alt='images' 
    className="w-full " />
...
<div className='absolute w-auto -mt-8 opacity-90   text-center font-bold 
   text-white  transform -translate-y-1/2 left-5 right-5 top-1/2'>
    ...
    <img src="https://i.ibb.co/CvDNYtt/14389305717-77ee3b4a40-o.jpg" alt='images' 
    className="w-full " />
