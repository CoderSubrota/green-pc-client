    ...
    const onSubmit = categoryData => {
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${image_bb_key}`, {
            ...
            .then(data => {
                ...
                fetch(`https://green-pc.vercel.app/categories`, {
                    method: "POST",
                    headers: {
            ...
            <div className="flex flex-row-reverse">
                ...
                <div className='mx-auto shadow-2xl my-9' style={{ width: "40%" }}>
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <h2 className='text-3xl font-bold text-center text-primary'> Add category </h2>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Product category </span>
                            </label>
                            <input id="inputColor" type="text" placeholder="Enter your product category name"
                                {...register("productCategory", {
                                    required: true,
                                })} className="input input-bordered" />
                            {errors.productCategory && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your resell price"  {...register("ProductPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" />
                            {errors.ProductPrice && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your orginal price"  {...register("orginalPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" />
                            {errors.orginalPrice && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="number" placeholder="Enter your phone number"
                                {...register("phoneNumber", {
                                    required: true,
                                })} className="input input-bordered" />
                            {errors.phoneNumber && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your purchase price"  {...register("PurchaseYear", {
                                required: true
                            }
                            )}
                                className="input input-bordered" />
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your location"
                                ...
                                className="input input-bordered" />
                            {errors.location && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                           ...
                           <select id="inputColor" {...register("productCondition", {
                            ...
                            {errors.productCondition && <p className='bg-error text-primary my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            {errors.description && <p className='bg-error text-primary my-2 p-3'>
