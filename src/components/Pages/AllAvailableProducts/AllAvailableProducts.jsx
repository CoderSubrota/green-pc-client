...
const AllAvailableProducts = () => {
    ...
    const { data: productItems = [], isLoading, refetch } = useQuery({
        queryKey: ['sellers'],
        queryFn: () =>
            fetch(`https://green-pc.vercel.app/availAbleProducts/${categoryId}`, {
                headers: {
    ...
    React.useEffect(() => {
        //get all users 
        axios.get("https://green-pc.vercel.app/users")
    ...
    const handleWishList = (productItem) => {
        ...
        axios.put(`https://green-pc.vercel.app/wishList/`, wishtListInfo)
            .then(res => {
    ...
    const handleReport = (product) => {
        axios.put(`https://green-pc.vercel.app/repot/${product._id}`)
            .then(res => {
                if (res.data.modifiedCount > 0) {
