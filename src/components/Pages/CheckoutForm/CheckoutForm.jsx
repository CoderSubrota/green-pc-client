...
const CheckoutForm = ({product}) => {
 ...
 const upateDocument = (updateData) => {
    axios.put("https://green-pc.vercel.app/updateDatabase" , updateData)
    .then(res  => res.data ) 
    ...
    //
//https://green-pc.vercel.app/
//https://green-pc.vercel.app/
//https://green-pc.vercel.app/
        axios.post("https://green-pc.vercel.app/create-payment-intent", price)
            .then((res) => {
