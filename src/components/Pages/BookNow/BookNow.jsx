...
const onSubmit = (bookingData) => {
 ...
 axios.post(`https://green-pc.vercel.app/orders` , bookingInformations)
 .then(res => {
...
<input id="inputColor" type="checkbox" id="bookingModal" className="modal-toggle" />
<div className="modal">
  <div className="modal-box relative">
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="card-body text-info">
        <div className="form-control">
          ...
          <input id="inputColor" type="text" placeholder="name" 
        ...
        <div className="form-control">
          ...
          <input id="inputColor" type="text" placeholder="password"
        ...
        <div className="form-control">
          ...
          <input id="inputColor" type="text" placeholder="product name "
        ...
        <div className="form-control">
          ...
          <input id="inputColor" type="text" placeholder="Please enter your phone number "
        ...
        <div className="form-control">
          ...
          <input id="inputColor" type="text" placeholder="Please enter your meeting location "
