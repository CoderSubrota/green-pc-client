...
const AddProuduct = () => {
    ...
    const onSubmit = productData => {
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${image_bb_key}`, {
            ...
            .then(productImageUrl => {
                ...
                fetch(`https://green-pc.vercel.app/products`, {
                    method: "POST",
                    headers: {
    ...
    //get category data
    React.useEffect(() => {
        axios.get(`https://green-pc.vercel.app/categoriesName`)
    ...
    React.useEffect(() => {
        ...
        axios.get(`https://green-pc.vercel.app/categoriesInfo/${categoryName}`)
            ...
            <div className="flex flex-row-reverse">
                ...
                text-2xl bg-blue-800  mx-2 rounded-full'></TiTick> </h2>
                        ...
                        <div className="form-control">
                           ...
                           <select id="inputColor"  {...register("productCategory", {
                                required: true,
                            ...
                            {errors.productCategory && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your product  name"
                                {...register("productName", {
                                    required: true,
                                })} className="input input-bordered" style={{ color: "blue" }} />
                            {errors.productName && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your purchase year"
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your resell product price"  {...register("ProductPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" style={{ color: "blue" }} />
                            {errors.ProductPrice && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your  buying product price"  {...register("orginalPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" style={{ color: "blue" }} />
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your phone number"
                                {...register("phoneNumber", {
                                    required: true,
                                })} className="input input-bordered" style={{ color: "blue" }} />
                            {errors.phoneNumber && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input id="inputColor" type="text" placeholder="Enter your location"
                                {...register("location", {
                                    required: true
                                })}
                                className="input text-primary" style={{ color: "blue" }} />
                            {errors.location && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                           ...
                           <select id="inputColor" {...register("productCondition", {
                                required: true,
                            })}
                            ...
                            {errors.productCondition && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            </label><textarea id="inputColor"a type="text" placeholder="Write   description about the product "
                                {...register("description", { required: true, })}
                                className="textarea textarea-bordered py-4 " />
                            {errors.description && <p className='bg-error my-2 p-3'>
                        ...
                        <div className="form-control">
                            ...
                            <div {...getRootProps()} className="hover:cursor-pointer">
                                <input id="inputColor" {...getInputProps()} />
                                {
                                    isDragActive ?
