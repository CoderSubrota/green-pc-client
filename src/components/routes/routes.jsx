...
export const routes = createBrowserRouter([
    {
        path: "/", element: <MainLayOut></MainLayOut>, children: [
            ...
            },
            {
                ...
                loader: async ({ params }) =>
                    fetch(`https://green-pc.vercel.app/availAbleProducts/${params.id}`, {
                        headers: {
            ...
            },
            {
                path: "/payments/:id",
                loader: async ({ params }) =>
                    fetch(`https://green-pc.vercel.app/productPayment/${params.id}`, {
                        headers: {
                            authorization: `Bearer ${localStorage.getItem("pc-shop-only")}`
                        }
                    }),
...

            {
                ...
                loader: async ({ params }) =>
                    fetch(`https://green-pc.vercel.app/wishListproductPayment/${params.id}`, {
                        headers: {
                            authorization: `Bearer ${localStorage.getItem("pc-shop-only")}`
                        }
                    }),
